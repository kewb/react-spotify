...
if (cluster.isMaster) {
  ...
  app.get("/login", function (req, res) {
    ...
    const scope =
      "user-read-private user-read-email user-read-recently-played user-top-read user-follow-read user-follow-modify playlist-read-private user-read-currently-playing playlist-read-collaborative playlist-modify-public";
  ...
  app.get("/refresh_token", function (req, res) {
    ...
    console.log('Received request to /refresh_token');
